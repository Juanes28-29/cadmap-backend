    ...
    fun crear(dto: CasoDTO): Result<CasoDTO> = runCatching {
        ...
        transaction {
            Casos.insert {
                ...
                it[fechaCierre] = dto.fechaCierre        // puede ser null
                it[ubicacionGeneral] = dto.ubicacionGeneral   // puede ser null
                it[ubicacionGeneralTxt] = dto.ubicacionGeneralTxt // puede ser null
                it[direccionGeneral] = dto.direccionGeneral // puede ser null
                it[municipio] = dto.municipio
                it[estadoProvincia] = dto.estadoProvincia // puede ser null
                it[pais] = dto.pais
